 ...
 root=Tk()
 root.config(bg="#dee9f1")
 root.title("Internet Speed Test")
 
 label=Label(root, text="Internet Speed Test", font=("Lucida Sansa Unicode", 20, "bold", "italic"), fg="#5D6D7E", bg="#dee8f1")
 ...
 label_upload=Label(root, text="Upload Speed", font=("Segoe Print", 18, "bold"), fg="#1E8449",bg="#dee8f1")
